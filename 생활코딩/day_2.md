...
**많은 사람들이 기초가 중요한 건 알지만, 기초만으로도 많은 것을 할 수 있다는 건 잘 잊는 것 같다.**
...
계속 시도하고 노력해야 한다. 어린이 단계가 있으니 어른이 된 것이다. 기본적인 규칙들을 조립해서 어떤 제품을 만들어 보라. 너무 많이 공부해버리면 무엇부터 해야할지 모르게된다. 객체지향, 디자인 패턴은 코드가 방대해질 경우에나 필요하다.
